...
class ActionFailed extends React.Component {
  constructor(props) {
    super(props)
  }
          ...
          <View style = {styles.mainView}>
            ...
            <View style = {styles.selectView}>
              ...
              <View style = {styles.successView}>
                <Text style = {{fontSize: 24, fontWeight: '700', color: 'red'}}>Action Failed</Text>
                <Text style = {{fontSize: 16, color: 'red'}}>Additional Info</Text>
              </View>
            </View>
          </View>
        </View>
        <View style = {styles.BottomView}>
          <TouchableOpacity style = {CustomStyle.middleNarrowButton} onPress = {() => this.props.nextStep(1)}>
